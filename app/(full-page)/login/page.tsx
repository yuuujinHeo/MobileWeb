      ...
      if (response.data.error != null) {
        ...
        if (response.data.error == 'blocked') {
          ...
          messages.current!.show({
            ...
            life: 3000,
            severity: 'error',
            summary: '관리자에게 문의 해주세요',
            detail: response.data.user.blocked_reason,
            closable: false,
          });
          ...
          messages.current?.show({
            ...
            severity: 'error',
            summary: '비밀번호가 틀렸습니다',
            detail: response.data.user.fail_count,
            closable: false,
          });
        ...
        <div className="flex flex-column align-items-center justify-content-center">
          <div
            style={{
              ...
              padding: '0.3rem',
              background:
                'linear-gradient(180deg, var(--red-500) 20%, rgba(0,0,0,0) 50%)',
            }}
          >
            <div className="box-login surface-card py-8 px-5 sm:px-8">
              ...
              {loading && (
                <ProgressSpinner className="loading-login "></ProgressSpinner>
              )}
              {!loading && (
                <div className="flex flex-column ">
                  <div className="w-full flex flex-column  align-items-center">
                    <img
                      src={`/layout/images/rainbow_logo.png`}
                  ...
                  <Button
                    label="게스트 로그인"
                    className="w-full p-3 mt-3 text-xl"
                    style={{
