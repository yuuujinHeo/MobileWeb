    ...
    if (Object.values(formik_robot.errors).every((value) => value == ''))
      if (Object.values(formik_debug.errors).every((value) => value == ''))
        if (Object.values(formik_loc.errors).every((value) => value == ''))
          if (
            Object.values(formik_control.errors).every((value) => value == '')
          )
            if (
              Object.values(formik_annotation.errors).every(
                (value) => value == ''
              )
            )
              if (
                Object.values(formik_default.errors).every(
                  (value) => value == ''
                )
              )
                if (
                  Object.values(formik_motor.errors).every(
                    (value) => value == ''
                  )
                )
                  if (
                    Object.values(formik_mapping.errors).every(
                      (value) => value == ''
                    )
                  )
                    if (
                      Object.values(formik_obs.errors).every(
                        (value) => value == ''
                      )
                    ) {
                      send_setting();
  ...
  const formik_control = useFormik({
    initialValues: {
      DRIVE_EXTENDED_CONTROL_TIME:
        settingState.control.DRIVE_EXTENDED_CONTROL_TIME,
    ...
    async function deletePreset() {
      try {
        ...
        const response = await axios.delete(
          mobileURL + '/setting/preset/' + selectPreset
        );
        setPresets(response.data);
        ...
        <div className="column">
          ...
          <div className="card grid">
            ...
            <ContextMenu
              ref={cm}
              model={menus}
              onHide={() => setSelectPreset(null)}
            />
            <BlockUI
              blocked={cur == undefined}
              template={
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.LIMIT_V !==
                                formik_preset.initialValues.LIMIT_V
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.LIMIT_W !==
                                formik_preset.initialValues.LIMIT_W
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.LIMIT_V_ACC !==
                                formik_preset.initialValues.LIMIT_V_ACC
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.LIMIT_W_ACC !==
                                formik_preset.initialValues.LIMIT_W_ACC
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.LIMIT_PIVOT_W !==
                                formik_preset.initialValues.LIMIT_PIVOT_W
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.PP_MIN_LD !==
                                formik_preset.initialValues.PP_MIN_LD
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.PP_MAX_LD !==
                                formik_preset.initialValues.PP_MAX_LD
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.PP_ST_V !==
                                formik_preset.initialValues.PP_ST_V
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            display:
                              cur !== undefined &&
                              formik_preset.values.PP_ED_V !==
                                formik_preset.initialValues.PP_ED_V
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
            ...
            <Panel header="로봇 기본 정보" id="TabRobotBasic">
              <p>
                ...
                <span
                  style={{
                    display:
                      formik_robot.values.PLATFORM_NAME !==
                      formik_robot.initialValues.PLATFORM_NAME
                        ? 'inline'
                        : 'none',
                    color: 'red',
                  }}
                ...
                <InputText
                  ...
                  className={
                    formik_robot.errors.PLATFORM_NAME
                      ? 'p-invalid' + ' p-inputtext-long'
                      : '' + 'p-inputtext-long'
                  }
                />
                <small
                  id="username-help"
                  style={{ color: 'red', fontSize: '1em', marginLeft: '1em' }}
                >
                  {formik_robot.errors.PLATFORM_NAME}
                </small>
              </span>
              <p style={{ marginTop: 15 }}>
                ...
                <span
                  style={{
                    display:
                      formik_robot.values.PLATFORM_TYPE !==
                      formik_robot.initialValues.PLATFORM_TYPE
                        ? 'inline'
                        : 'none',
                    color: 'red',
                  }}
            ...
            <Panel header="디버그 모드" id="TabRobotBasic">
              <p>
                ...
                <span
                  style={{
                    display:
                      formik_debug.values.SIM_MODE !==
                      formik_debug.initialValues.SIM_MODE
                        ? 'inline'
                        : 'none',
                    color: 'red',
                  }}
              ...
              <div className="card">
                <p>
                  ...
                  <span
                    style={{
                      display:
                        formik_motor.values.MOTOR_ID_L !==
                        formik_motor.initialValues.MOTOR_ID_L
                          ? 'inline'
                          : 'none',
                      color: 'red',
                    }}
                ...
                <p style={{ marginTop: 15 }}>
                  ...
                  <span
                    style={{
                      display:
                        formik_motor.values.MOTOR_ID_R !==
                        formik_motor.initialValues.MOTOR_ID_R
                          ? 'inline'
                          : 'none',
                      color: 'red',
                    }}
                ...
                <p style={{ marginTop: 15 }}>
                  ...
                  <span
                    style={{
                      display:
                        formik_motor.values.MOTOR_DIR !==
                        formik_motor.initialValues.MOTOR_DIR
                          ? 'inline'
                          : 'none',
                      color: 'red',
                    }}
                ...
                <p style={{ marginTop: 15 }}>
                  ...
                  <span
                    style={{
                      display:
                        formik_motor.values.MOTOR_GEAR_RATIO !==
                        formik_motor.initialValues.MOTOR_GEAR_RATIO
                          ? 'inline'
                          : 'none',
                      color: 'red',
                    }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_LIMIT_V !==
                            formik_motor.initialValues.MOTOR_LIMIT_V
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_LIMIT_V_ACC !==
                            formik_motor.initialValues.MOTOR_LIMIT_V_ACC
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_LIMIT_W !==
                            formik_motor.initialValues.MOTOR_LIMIT_W
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_LIMIT_W_ACC !==
                            formik_motor.initialValues.MOTOR_LIMIT_W_ACC
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_GAIN_KP !==
                            formik_motor.initialValues.MOTOR_GAIN_KP
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_GAIN_KI !==
                            formik_motor.initialValues.MOTOR_GAIN_KI
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                  ...
                  <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                    <p>
                      ...
                      <span
                        style={{
                          display:
                            formik_motor.values.MOTOR_GAIN_KD !==
                            formik_motor.initialValues.MOTOR_GAIN_KD
                              ? 'inline'
                              : 'none',
                          color: 'red',
                        }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_CHECK_DIST !==
                          formik_loc.initialValues.LOC_CHECK_DIST
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_CHECK_IE !==
                          formik_loc.initialValues.LOC_CHECK_IE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_CHECK_IR !==
                          formik_loc.initialValues.LOC_CHECK_IR
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_FUSION_RATIO !==
                          formik_loc.initialValues.LOC_FUSION_RATIO
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_ICP_COST_THRESHOLD !==
                          formik_loc.initialValues.LOC_ICP_COST_THRESHOLD
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_ICP_ERROR_THRESHOLD !==
                          formik_loc.initialValues.LOC_ICP_ERROR_THRESHOLD
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_loc.values.LOC_ICP_MAX_FEATURE_NUM !==
                          formik_loc.initialValues.LOC_ICP_MAX_FEATURE_NUM
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_ICP_COST_THRESHOLD !==
                          formik_mapping.initialValues.SLAM_ICP_COST_THRESHOLD
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_ICP_DO_ACCUM_NUM !==
                          formik_mapping.initialValues.SLAM_ICP_DO_ACCUM_NUM
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_ICP_DO_ERASE_GAP !==
                          formik_mapping.initialValues.SLAM_ICP_DO_ERASE_GAP
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_ICP_ERROR_THRESHOLD !==
                          formik_mapping.initialValues.SLAM_ICP_ERROR_THRESHOLD
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_ICP_MAX_FEATURE_NUM !==
                          formik_mapping.initialValues.SLAM_ICP_MAX_FEATURE_NUM
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_ICP_VIEW_THRESHOLD !==
                          formik_mapping.initialValues.SLAM_ICP_VIEW_THRESHOLD
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_KFRM_LC_TRY_DIST !==
                          formik_mapping.initialValues.SLAM_KFRM_LC_TRY_DIST
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_KFRM_LC_TRY_OVERLAP !==
                          formik_mapping.initialValues.SLAM_KFRM_LC_TRY_OVERLAP
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_KFRM_UPDATE_NUM !==
                          formik_mapping.initialValues.SLAM_KFRM_UPDATE_NUM
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_VOXEL_SIZE !==
                          formik_mapping.initialValues.SLAM_VOXEL_SIZE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_mapping.values.SLAM_WINDOW_SIZE !==
                          formik_mapping.initialValues.SLAM_WINDOW_SIZE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
            ...
            <Panel header="어노테이션">
              <p style={{ width: i_size }}>
                ...
                <span
                  style={{
                    display:
                      formik_annotation.values.ANNOT_QA_STEP !==
                      formik_annotation.initialValues.ANNOT_QA_STEP
                        ? 'inline'
                        : 'none',
                    color: 'red',
                  }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_control.values.DRIVE_EXTENDED_CONTROL_TIME !==
                          formik_control.initialValues
                            .DRIVE_EXTENDED_CONTROL_TIME
                            ? 'inline'
                            : 'none',
                        color: 'red',
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_control.values.DRIVE_GOAL_D !==
                          formik_control.initialValues.DRIVE_GOAL_D
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_control.values.DRIVE_GOAL_TH !==
                          formik_control.initialValues.DRIVE_GOAL_TH
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_obs.values.OBS_AVOID_DIST !==
                          formik_obs.initialValues.OBS_AVOID_DIST
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_obs.values.OBS_MAP_GRID_SIZE !==
                          formik_obs.initialValues.OBS_MAP_GRID_SIZE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_obs.values.OBS_MAP_MARGIN !==
                          formik_obs.initialValues.OBS_MAP_MARGIN
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_obs.values.OBS_MAP_RANGE !==
                          formik_obs.initialValues.OBS_MAP_RANGE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_obs.values.OBS_SIZE_THRESHOLD !==
                          formik_obs.initialValues.OBS_SIZE_THRESHOLD
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_obs.values.OBS_TARGET_DIST !==
                          formik_obs.initialValues.OBS_TARGET_DIST
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
          ...
          <div className="column">
            <Panel header="로봇 최대 사이즈">
              <div className="grid gap-5 mr-3 ml-3 mt-3 mb-3">
                <div>
                  <p style={{ width: i_size }}>
                    <span style={{ fontSize: 18, fontWeight: 700 }}>X</span>
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_SIZE_MAX_X !==
                          formik_default.initialValues.ROBOT_SIZE_MAX_X
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_SIZE_MAX_Y !==
                          formik_default.initialValues.ROBOT_SIZE_MAX_Y
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    <span style={{ fontSize: 18, fontWeight: 700 }}>Z</span>
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_SIZE_MAX_Z !==
                          formik_default.initialValues.ROBOT_SIZE_MAX_Z
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_SIZE_MIN_X !==
                          formik_default.initialValues.ROBOT_SIZE_MIN_X
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_SIZE_MIN_Y !==
                          formik_default.initialValues.ROBOT_SIZE_MIN_Y
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_SIZE_MIN_Z !==
                          formik_default.initialValues.ROBOT_SIZE_MIN_Z
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_RADIUS !==
                          formik_default.initialValues.ROBOT_RADIUS
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_WHEEL_BASE !==
                          formik_default.initialValues.ROBOT_WHEEL_BASE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.ROBOT_WHEEL_RADIUS !==
                          formik_default.initialValues.ROBOT_WHEEL_RADIUS
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                ...
                <div>
                  <p style={{ width: i_size }}>
                    ...
                    <span
                      style={{
                        display:
                          formik_default.values.LIDAR_MAX_RANGE !==
                          formik_default.initialValues.LIDAR_MAX_RANGE
                            ? 'inline'
                            : 'none',
                        color: 'red',
                      }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_B_X !==
                              formik_default.initialValues.LIDAR_TF_B_X
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_B_Y !==
                              formik_default.initialValues.LIDAR_TF_B_Y
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_B_Z !==
                              formik_default.initialValues.LIDAR_TF_B_Z
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_B_RX !==
                              formik_default.initialValues.LIDAR_TF_B_RX
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_B_RY !==
                              formik_default.initialValues.LIDAR_TF_B_RY
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_B_RZ !==
                              formik_default.initialValues.LIDAR_TF_B_RZ
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_F_X !==
                              formik_default.initialValues.LIDAR_TF_F_X
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_F_Y !==
                              formik_default.initialValues.LIDAR_TF_F_Y
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_F_Z !==
                              formik_default.initialValues.LIDAR_TF_F_Z
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_F_RX !==
                              formik_default.initialValues.LIDAR_TF_F_RX
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_F_RY !==
                              formik_default.initialValues.LIDAR_TF_F_RY
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
                    ...
                    <div>
                      <p style={{ width: i_size }}>
                        ...
                        <span
                          style={{
                            display:
                              formik_default.values.LIDAR_TF_F_RZ !==
                              formik_default.initialValues.LIDAR_TF_F_RZ
                                ? 'inline'
                                : 'none',
                            color: 'red',
                          }}
