...
import {SettingState, ROBOT_TYPE,_robot, _debug, _loc, _control, _annotation, _default, _motor, _mapping, _obs} from '../../../interface/settings';
...
const Setting: React.FC = () => {
    ...
    const PopupPreset = () =>{
        ...
        return(
            <Dialog header="Preset" visible={visiblePreset} onHide={()=>setVisiblePreset(false)}>
                <div className='card grid'>
                    <ListBox value={selectPreset} onChange={(e) => setSelectPreset(e.value)} options={presets}
                    className='w-full md:w-14rem' listStyle={{height: '250px'}} />
                    <div className="card">
                            <div className="column"> 
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>DRIVE_EXTENDED_CONTROL_TIME</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>DRIVE_GOAL_D</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>DRIVE_GOAL_TH</span>
        ...
        <main>
            ...
            <TabView>
                        ...
                        <Panel header = "디버그 모드" id="TabRobotBasic" > 
                            ...
                            <span className="p-float-label">
                                <InputText
                                    name="SIM_MODE"
                                    type="number"
                                    onChange={formik_debug.handleChange}
                ...
                <TabPanel header="매핑 / 정확도" leftIcon="pi pi-map mr-2 ml-2">
                    <div className="card column" > 
                        <Panel header = "위치 정확도"  >
                            <div className="column"> 
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_CHECK_DIST</span>
                                <span style={{display:formik_loc.values.LOC_CHECK_DIST!==formik_loc.initialValues.LOC_CHECK_DIST?"inline":"none", color:"red"}}>    (수정됨)</span></p>
                                <InputNumber
                                    name = "LOC_CHECK_DIST"
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_CHECK_IE</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_CHECK_IR</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_FUSION_RATIO</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_ICP_COST_THRESHOLD</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_ICP_ERROR_THRESHOLD</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>LOC_ICP_MAX_FEATURE_NUM</span>
                        ...
                        <Panel header = "매핑"  >
                            <div className="column"> 
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_ICP_COST_THRESHOLD</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_ICP_DO_ACCUM_NUM</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_ICP_DO_ERASE_GAP</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_ICP_ERROR_THRESHOLD</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_ICP_MAX_FEATURE_NUM</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_ICP_VIEW_THRESHOLD</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_KFRM_LC_TRY_DIST</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_KFRM_LC_TRY_OVERLAP</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_KFRM_UPDATE_NUM</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_VOXEL_SIZE</span>
                            ...
                            <div> 
                                <p ><span style={{fontSize:18,fontWeight: 700}}>SLAM_WINDOW_SIZE</span>
                        ...
                        <Panel header = "어노테이션"  >
                            <p ><span style={{fontSize:18,fontWeight: 700}}>ANNOT_QA_STEP</span>
                ...
                <TabPanel header="주행 / 감지" leftIcon="pi pi-car mr-2 ml-2">
                    <div className="card column">
                    <Panel header = "주행 속도"  >
                        <Button onClick={() => setVisiblePreset(true)}>프리셋 설정</Button>
                    </Panel>
                    <Panel header = "주행 컨트롤"  >
                            <div className="column"> 
                            <div> 
                    ...
                    <Panel header = "장애물 감지"  >
                        <div className="column"> 
                        <div> 
                            <p ><span style={{fontSize:18,fontWeight: 700}}>OBS_AVOID_DIST</span>
                        ...
                        <div> 
                            <p ><span style={{fontSize:18,fontWeight: 700}}>OBS_MAP_GRID_SIZE</span>
                        ...
                        <div> 
                            <p ><span style={{fontSize:18,fontWeight: 700}}>OBS_MAP_MARGIN</span>
                        ...
                        <div> 
                            <p ><span style={{fontSize:18,fontWeight: 700}}>OBS_MAP_RANGE</span>
                        ...
                        <div> 
                            <p ><span style={{fontSize:18,fontWeight: 700}}>OBS_SIZE_THRESHOLD</span>
                        ...
                        <div> 
                            <p ><span style={{fontSize:18,fontWeight: 700}}>OBS_TARGET_DIST</span>
                ...
                <TabPanel header="로봇 특성" leftIcon="pi pi-cog mr-2 ml-2">
                    <div className="card column" > 
                        <Panel header = "로봇 최대 사이즈">
                            <div className="grid formgrid">
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p ><span style={{fontSize:18,fontWeight: 700}}>X</span>
                                ...
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p ><span style={{fontSize:18,fontWeight: 700}}>Y</span>
                                ...
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p ><span style={{fontSize:18,fontWeight: 700}}>Z</span>
                        ...
                        <Panel header = "라이다">
                            <p><span style={{fontSize:18,fontWeight: 700}}>라이다 최대 거리</span>
                            ...
                            <p style={{marginTop:15}}><span style={{fontSize:18,fontWeight: 700}}>백 라이다 TF</span></p>
                            <div className="card grid row formgrid">
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p ><span style={{fontSize:18,fontWeight: 700}}>X</span>
                                ...
                                <div className="col-3 mb-2 lg:col-4 lg:mb-0">
                                    <p ><span style={{fontSize:18,fontWeight: 700}}>Y</span>
                                ...
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p style={{marginTop:15}}><span style={{fontSize:18,fontWeight: 700}}>RX</span>
                                ...
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p style={{marginTop:15}}><span style={{fontSize:18,fontWeight: 700}}>RY</span>
                                ...
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p style={{marginTop:15}}><span style={{fontSize:18,fontWeight: 700}}>RZ</span>
                            ...
                            <p style={{marginTop:15}}><span style={{fontSize:18,fontWeight: 700}}>프론트 라이다 TF</span></p>
                            <div className="card grid row formgrid">
                                <div className="col-12 mb-2 lg:col-4 lg:mb-0">
                                    <p ><span style={{fontSize:18,fontWeight: 700}}>X</span>
