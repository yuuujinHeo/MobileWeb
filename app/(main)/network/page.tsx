...
const Network:React.FC = () =>{
    ...
    const PopupWifi = () =>{
        ...
        const connectWifi = async(wifi: any) =>{
        ...
        const renderListItem = (wifi: { ssid: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined; quality: any; }) => {
            return (
    ...
    return (
        ...
        <Panel header={"Ethernet ("+curEthernet?.[0].name+" : "+curEthernet?.[0].device+")"}>
            {curEthernet?.[0] &&
             ...
             <div className='grid gap-3' >
                 ...
                 <Button onClick={save_ethernet_1}>적용</Button>
             </div>
        ...
        <Panel header={"Ethernet ("+curEthernet?.[1].name+" : "+curEthernet?.[1].device+")"}>
             ...
             <div className='grid gap-3' >
                 <Button onClick={refresh}>초기화</Button>
                 <Button onClick={save_ethernet_2}>적용</Button>
             </div>
             <div className="flex-auto">
                 <label className="font-bold block mb-2">
                     Name
        ...
        {(curBt?.[0] && curBt?.[0].name != '--') &&
            <Panel header={"Bluetooth ("+curBt[0].name+" : "+curBt?.[0].device+")"}>
                ...
                <div className='grid gap-3' >
                    <Button onClick={refresh}>초기화</Button>
                    <Button onClick={save_bt}>적용</Button>
                </div>
                <div className="flex-auto">
                    <label className="font-bold block mb-2">
                        Name
