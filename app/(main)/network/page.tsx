...
const Network: React.FC = () => {
  ...
  async function save_ethernet_1() {
    ...
    try {
      const response = await axios.put(
        mobileURL + '/network/ethernet1',
        formik_ethernet1.values
      );
  ...
  async function save_ethernet_2() {
    ...
    try {
      const response = await axios.put(
        mobileURL + '/network/ethernet2',
        formik_ethernet2.values
      );
      console.log(response);
    } catch (error) {
      console.error(error);
  ...
  const PopupWifi = () => {
    ...
    const PopupPassword = () => {
      ...
      return (
        <Dialog
          header={newWifi}
          style={{ width: '350px' }}
          visible={visibleWifiPassword}
          onHide={() => setVisibleWifiPassword(false)}
        >
    ...
    const connectWifi = async (
      ...
      try {
        ...
        var response;
        response = await axios.post(mobileURL + '/network/wifi', {
          ...wifi,
          password: password,
        });
    ...
    return (
      <Dialog
        ...
        visible={visibleWifi}
        onHide={() => setVisibleWifi(false)}
      >
        <PopupPassword></PopupPassword>
        <div className=" flex justify-content-center">
          {block && <ProgressSpinner aria-label="Loading" />}
          {!block && (
            <DataView
              value={wifis}
              // layout={'list'}
  ...
  return (
    <div className="column gap-3">
        ...
        {curEthernet?.[0] && curEthernet?.[0].name != '--' && (
          <div className="column ">
            <div className="grid gap-3">
              ...
              <Button disabled={loading} onClick={save_ethernet_1}>
                적용
              </Button>
            </div>
            {loading ? (
              ...
              <div className="column">
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_ethernet1.errors.name ? 'p-invalid' : ''
                    }`}
                  />
                </div>

                <div className="flex-auto mb-2">
                  <label className="font-bold block mb-2">Mac Address</label>
                  <InputText
                    name="mac"
                    type="text"
                    readOnly
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_ethernet1.errors.mac ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-5 ">
                  <div className="flex-auto">
                    <label className="font-bold block mb-2">IP</label>
                    <InputText
                      name="ip"
                      type="text"
                      onChange={formik_ethernet1.handleChange}
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_ethernet1.errors.ip ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                  <div className="flex-auto">
                    <label className="font-bold block mb-2">Subnet</label>
                    <InputText
                      name="subnet"
                      type="text"
                      onChange={formik_ethernet1.handleChange}
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_ethernet1.errors.subnet ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                </div>
                ...
                <div className="flex-auto">
                  <label className="font-bold block mb-2">Gateway</label>
                  <InputText
                    name="gateway"
                    type="text"
                    onChange={formik_ethernet1.handleChange}
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_ethernet1.errors.gateway ? 'p-invalid' : ''
                    }`}
                  />
                </div>

                {formik_ethernet1.values.dns &&
                  formik_ethernet1.values.dns?.length > 0 && (
                    <div className="flex-auto">
                      <label className="font-bold block mb-2">DNS_Main</label>
                      <InputText
                        name="dns[0]"
                        type="text"
                        onChange={formik_ethernet1.handleChange}
                        ...
                        className={`w-full p-inputtext-long ${
                          formik_ethernet1.errors.dns &&
                          formik_ethernet1.errors.dns![0]
                            ? 'p-invalid'
                            : ''
                        }`}
                      />
                ...
                {formik_ethernet1.values.dns?.[1] &&
                  formik_ethernet1.values.dns[1] != '' && (
                    <div className="flex-auto mb-4">
                      <label className="font-bold block mb-2">DNS_Serv</label>
                      <InputText
                        name="dns[1]"
                        type="text"
                        onChange={formik_ethernet1.handleChange}
        ...
        >
          <div className="column ">
            <div className="grid gap-3">
              ...
              <Button disabled={loading} onClick={save_ethernet_2}>
                적용
              </Button>
            </div>
            {loading ? (
              ...
              <div className="column">
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_ethernet2.errors.name ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex-auto mb-2">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_ethernet2.errors.mac ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-5 ">
                  <div className="flex-auto">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_ethernet2.errors.ip ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                  <div className="flex-auto">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_ethernet2.errors.subnet ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                </div>
                ...
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_ethernet2.errors.gateway ? 'p-invalid' : ''
                    }`}
                  />
                </div>

                {formik_ethernet2.values.dns &&
                  formik_ethernet2.values.dns?.length > 0 && (
                    <div className="flex-auto">
                      <label className="font-bold block mb-2">DNS_Main</label>
                      <InputText
                        name="dns[0]"
                        ...
                        className={`w-full p-inputtext-long ${
                          formik_ethernet2.errors.dns &&
                          formik_ethernet2.errors.dns![0]
                            ? 'p-invalid'
                            : ''
                        }`}
                      />
      ...
      {curWifi?.[0] && curWifi?.[0].name != '--' && (
        <Panel
          header={
            'Wifi (' + curWifi[0].name + ' : ' + curWifi?.[0].device + ')'
          }
        >
          <div className="column">
            <div className="grid gap-3">
              ...
              <Button disabled={loading} onClick={showWifiPopup}>
                검색
              </Button>
              <Button disabled={loading} onClick={save_wifi}>
                적용
              </Button>
            </div>
            {loading ? (
              ...
              <div className="column">
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_wifi.errors.name ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex-auto mb-2">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_wifi.errors.mac ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-5 ">
                  <div className="flex-auto">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_wifi.errors.ip ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                  <div className="flex-auto">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_wifi.errors.subnet ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                </div>
                ...
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_wifi.errors.gateway ? 'p-invalid' : ''
                    }`}
                  />
                </div>

                {formik_wifi.values.dns &&
                  formik_wifi.values.dns?.length > 0 && (
                    <div className="flex-auto">
                      <label className="font-bold block mb-2">DNS_Main</label>
                      <InputText
                        name="dns[0]"
                        ...
                        className={`w-full p-inputtext-long ${
                          formik_wifi.errors.dns && formik_wifi.errors.dns![0]
                            ? 'p-invalid'
                            : ''
                        }`}
                      />
                  ...
                  formik_wifi.values.dns[1] != '' && (
                    <div className="flex-auto mb-4">
                      ...
                      <InputText
                        ...
                        className={`w-full p-inputtext-long ${
                          formik_wifi.errors.dns && formik_wifi.errors.dns![1]
                            ? 'p-invalid'
                            : ''
                        }`}
                      />
      ...
      {curBt?.[0] && curBt?.[0].name != '--' && (
        <Panel
          header={
            'Bluetooth (' + curBt[0].name + ' : ' + curBt?.[0].device + ')'
          }
        >
          <div className="column ">
            <div className="grid gap-3">
              ...
              <Button disabled={loading} onClick={save_bt}>
                적용
              </Button>
            </div>
            {loading ? (
              ...
              <div className="column">
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_bt.errors.name ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex-auto mb-2">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_bt.errors.mac ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-5 ">
                  ...
                  <div className="flex-auto">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_bt.errors.subnet ? 'p-invalid' : ''
                      }`}
                    />
                  </div>
                </div>
                ...
                <div className="flex-auto">
                  ...
                  <InputText
                    ...
                    className={`w-full p-inputtext-long ${
                      formik_bt.errors.gateway ? 'p-invalid' : ''
                    }`}
                  />
                </div>
                ...
                {formik_bt.values.dns && formik_bt.values.dns?.length > 0 && (
                  <div className="flex-auto">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_bt.errors.dns && formik_bt.errors.dns![0]
                          ? 'p-invalid'
                          : ''
                      }`}
                    />
                ...
                {formik_bt.values.dns?.[1] && formik_bt.values.dns[1] != '' && (
                  <div className="flex-auto mb-4">
                    ...
                    <InputText
                      ...
                      className={`w-full p-inputtext-long ${
                        formik_bt.errors.dns && formik_bt.errors.dns![1]
                          ? 'p-invalid'
                          : ''
                      }`}
                    />
