            ...
            <div className="card p-fluid">
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8 md:col-10">
                  <SelectButton
                    value={Status.motor0.connection}
                    className={
                      Status.motor0.connection === 'true' ? 'con' : 'discon'
                    }
                    readOnly
                    options={[
                      { label: 'Disconnect', value: 'false' },
                ...
                <div className="col-12 w-8 md:col-10">
                  {Status.motor0.connection && (
                    <div className="flex gap-2 ">
                      ...
                      {Status.motor0.status.running && (
                        <Tag severity="success" value="Motor On" />
                      )}
                      {Status.motor0.status.mode && (
                        <Tag severity="danger" value="Mod" />
                      )}
                      {Status.motor0.status.jam && (
                        <Tag severity="danger" value="Jam" />
                      )}
                      {Status.motor0.status.current && (
                        <Tag severity="danger" value="Cur" />
                      )}
                      {Status.motor0.status.big && (
                        <Tag severity="danger" value="Big" />
                      )}
                      {Status.motor0.status.input && (
                        <Tag severity="danger" value="Inp" />
                      )}
                      {Status.motor0.status.position && (
                        <Tag severity="danger" value="Pos" />
                      )}
                      {Status.motor0.status.collision && (
                        <Tag severity="danger" value="Col" />
                      )}
                    </div>
                  )}
                </div>
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8 md:col-10">
                  <InputNumber
                    value={Status.motor0.temperature}
                    readOnly
                    suffix="℃"
                  />
                </div>
          ...
          <div className="col-12 md:col-6">
            <div className="card p-fluid">
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8 md:col-10">
                  <SelectButton
                    value={Status.motor1.connection}
                    className={
                      Status.motor1.connection === 'true' ? 'con' : 'discon'
                    }
                    readOnly
                    options={[
                      { label: 'Disconnect', value: 'false' },
                ...
                <div className="col-12 w-8 md:col-10">
                  {Status.motor1.connection && (
                    <div className="flex gap-2 ">
                      ...
                      {Status.motor1.status.mode && (
                        <Tag severity="danger" value="Mod" />
                      )}
                      {Status.motor1.status.jam && (
                        <Tag severity="danger" value="Jam" />
                      )}
                      {Status.motor1.status.current && (
                        <Tag severity="danger" value="Cur" />
                      )}
                      {Status.motor1.status.big && (
                        <Tag severity="danger" value="Big" />
                      )}
                      {Status.motor1.status.input && (
                        <Tag severity="danger" value="Inp" />
                      )}
                      {Status.motor1.status.position && (
                        <Tag severity="danger" value="Pos" />
                      )}
                      {Status.motor1.status.collision && (
                        <Tag severity="danger" value="Col" />
                      )}
                    </div>
                  )}
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8 md:col-10">
                  <InputNumber
                    value={Status.motor1.temperature}
                    readOnly
                    suffix="℃"
                  />
                </div>
          ...
          <div className="col-12 md:col-6">
            <div className="card p-fluid">
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8  md:col-10">
                  <InputNumber
                    value={Status.power.bat_current}
                    readOnly
                    suffix="A"
                  />
                </div>
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12  w-8 md:col-10">
                  <InputNumber
                    value={Status.power.total_power}
                    readOnly
                    suffix="Wh"
                  />
                </div>
          ...
          <div className="col-12 md:col-6">
            <div className="card p-fluid">
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8 md:col-10">
                  <SelectButton
                    value={Status.state.power}
                    className={Status.state.power === 'true' ? 'con' : 'discon'}
                    readOnly
                    options={[
              ...
              <div className="field grid gap-5">
                ...
                <div className="col-12 w-8  md:col-10">
                  <SelectButton
                    value={Status.state.emo}
                    className={Status.state.emo === 'true' ? 'con' : 'discon'}
                    readOnly
                    options={[
