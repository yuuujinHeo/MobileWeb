...
const Dashboard = () => {
  ...
  const batteryData: Datainfo[] = useMemo(
    () => logBattery.map((item) => ({ time: item.time, value: item.value })),
    [logBattery]
  );
      ...
      <div className="layout-main">
        <div className="layout-top">
          <div className="card state-box">
            <h4 className="state-text2">{Status.power.bat_out} V</h4>
            <h3 className="state-text">Battery</h3>
            <div className="chart-box">
              <ChartEx data={batteryData} />
            </div>
          </div>
          <div className="card state-box">
            <h3 className="state-text">Motor</h3>
          ...
          <div className="card state-box">
            <h3 className="state-text">State</h3>
            <h4 className="state-text2">{stateChip()}</h4>
          ...
          <div className="card state-box">
            <h3 className="state-text">Program</h3>
